...
<!-- Mirrored from cvresumetemplate.com/maha-personal-cv-resume-html-template/home-two-w.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 04:55:29 GMT -->
<head>
        <title>Kamran Asif - Personal CV/Resume </title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <nav class="navbar navbar-expand-lg mh-nav nav-btn">
                        <a class="navbar-brand" id="icon_div" href="#">
                            <img src="assets/images/logo.png" width="50%" alt="maha" class="img-fluid pl-3 mt-2">
                            <!-- <h2>Maha</h2> -->
                        </a>
                        <button class="navbar-toggler" type="button" style="margin-top: auto; margin-bottom: auto;" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="row section-separator xs-column-reverse vertical-middle-content home-padding">
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                ...
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Kamran Asif</h2>
                                <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">Full Stack Developer</h4>
                                
                                <ul>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a href="mailto:">kamranassif506@gmail.com</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i class="fa fa-phone"></i><a href="callto:">+92 300 4862070</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i><address>Punjab, Pakistan</address></li>
                                </ul>
                        ...
                        <div class="col-sm-6">
                            <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <div class="img-border">
                                    <img src="assets/images/kamran.png" alt=""  class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="mh-featured-project-content">
                                                <h4 class="project-category wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">Website Development</h4>
                                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">CareerCenter</h2>
                                                <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">Laravel Development</span>
                                                <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">During my time working on the careercenter.am website, my primary responsibilities included making
                                ...
                                <div class="col-sm-12 mh-featured-item">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="mh-featured-project-content">
                                                <h4 class="project-category wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">Website Development</h4>
                                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">Training Web Portal</h2>
                                                <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">CodeIgniter Development</span>
                                                <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">The CodeIgniter-based training website comprises admin 
                                                    and student dashboards. Students log in to access personalized training in addition, 
                                                    subtraction, multiplication, and division across various levels. 
                                                    Timed answering helps achieve goals and pass rates. 
                                                    The platform offers progress reports, profile management, and password changes. 
                                                    It provides an engaging, efficient, and user-friendly learning experience with comprehensive insights.
                                                    Admin Dashboard Link: https://uvisionpk.com/kamran/asmd/admin/login
                                                    username: admin password: admin.</p>
                                                <a href="https://uvisionpk.com/kamran/asmd" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">Visit Website</a>
                            ...
                            <div class="mh-work">
                                ...
                                <div class="mh-experience-deatils">
                                    ...
                                    <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                        <h4>PHP Developer at <a href="https://uvisionpk.com/">Uvision</a></h4>
                                        <div class="mh-eduyear">2020-2023</div>
                                        <span>Responsibility :</span>
                                        <ul class="work-responsibility">
                                            <li><i class="fa fa-circle"></i>Bug Fixing</li>
                                            <li><i class="fa fa-circle"></i>Website Development</li>
                                            <li><i class="fa fa-circle"></i>Website Maintainance</li>
                                            <li><i class="fa fa-circle"></i>WordPress Plugin Development</li>
                                            <li><i class="fa fa-circle"></i>RestFull API development</li>
                                            <li><i class="fa fa-circle"></i>ERP Software Development</li>
                                        </ul>
                                    </div>                                
                                    <!-- Education Institutes-->
                                    <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                        <h4>Full Stack developer at <a href="https://www.fiverr.com/kamranasif304?up_rollout=true">Fiverr</a></h4>
                                        <div class="mh-eduyear">2020-working</div>
                                        <span>Responsibility :</span>
                                        <ul class="work-responsibility">
                                            <li><i class="fa fa-circle"></i>Bug Fixing</li>
                                            <li><i class="fa fa-circle"></i>Website Development</li>
                                            ...
                                            <li><i class="fa fa-circle"></i>WordPress Plugin Development</li>
                                            <li><i class="fa fa-circle"></i>RestFull API development</li>
                                            <li><i class="fa fa-circle"></i>Google App Scripting</li>
                                            <li><i class="fa fa-circle"></i>Wordpress Development</li>
                                        </ul>
                                    </div>                                
                                    <!-- Education Institutes-->
                    ...
                    <div class="part col-sm-12">
                        ...
                        <div class="mh-project-gallery col-sm-12 wow fadeInUp" id="project-gallery" data-wow-duration="0.8s" data-wow-delay="0.5s">
                            <div class="portfolioContainer row">
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 laravel">
                                    <figure>
                                        <img src="assets/images/careercenter.png" alt="img04">
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 ui codeigniter">
                                    <figure>
                                        <img src="assets/images/asmd.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 codeigniter">
                                    <figure style="border: 1px solid #808080a1;">
                                        <img src="assets/images/school.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 react">
                                    <figure>
                                        <img src="assets/images/abc.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 codeigniter">
                                    <figure>
                                        <img src="assets/images/upos.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                ...
                                <div class="grid-item col-md-4 col-sm-6 col-xs-12 laravel">
                                    <figure>
                                        <img src="assets/images/tours.png" alt="img04">
                                        <figcaption class="fig-caption">
                                            <i class="fa fa-search"></i>
                                ...
                                <div class="col-sm-12 col-md-6 mh-footer-address">
                                    <div class="col-sm-12 xs-no-padding">
                                        <div class="mh-address-footer-item dark-bg shadow-1 media wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                            ...
                                            <div class="each-info media-body">
                                                <h4>Address</h4>
                                                <address>
                                                    Al-Kareem Plaza, Jauharabad 1st Floor <br> 
                                                     Punjab, Pakistan
                                                </address>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 xs-no-padding">
                                        <div class="mh-address-footer-item media dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                            ...
                                            <div class="each-info media-body">
                                                <h4>Email</h4>
                                                <a href="kamranasif506@gmai.com">kamranasif506@gmail.com</a><br>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 xs-no-padding">
                                        <div class="mh-address-footer-item media dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                            ...
                                            <div class="each-info media-body">
                                                <h4>Phone</h4>
                                                <a href="callto:+923004862070">+92300-4862070</a><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                    <form id="contactForm" class="single-form quate-form wow fadeInUp" data-toggle="validator" action="https://formspree.io/f/xdovbgea" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="text-left text-xs-center">
                                                <p>All right reserved Kamran Asif @ 2023</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
